static class OPProduct
{
    public static void CreateProduct(){
        ...
        if(View.List2().Count() == 0){
            OPCategory.ListC2(); 
            Console.WriteLine("É Preciso de uma Categoria para Inserir um Produto!");
        } else {
    ...
    public static void PricePercentage(){
        if(View.List3().Count() == 0){
            ListP();
            Console.WriteLine("O Reajuste não pode ser Feito sem Produtos!");
        } else {
